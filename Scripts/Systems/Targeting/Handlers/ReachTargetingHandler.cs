...
/// <summary>
/// Targeting handler for reach attacks (polearms, spears, etc.).
/// Uses Chebyshev (grid) distance with line-of-sight.
/// Targets hostile creatures within range.
/// </summary>
public class ReachTargetingHandler : TargetingHandler
{
    public override TargetingType TargetType => TargetingType.Reach;
        ...
        ActionContext context)
    {
        ...
        // Reach uses Chebyshev distance but still requires LOS
        var visibleTiles = FOVCalculator.CalculateVisibleTiles(
            casterPos, range, context.MapSystem, DistanceMetric.Chebyshev);
