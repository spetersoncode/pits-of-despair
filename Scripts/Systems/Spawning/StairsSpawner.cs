...
public class StairsSpawner
{
    ...
    private const string STAIRS_SCENE = "res://Scenes/Entities/Stairs.tscn";
    private const string THRONE_SCENE = "res://Scenes/Entities/ThroneOfDespair.tscn";
    ...
    {
        var scene = GD.Load<PackedScene>(STAIRS_SCENE);
        if (scene == null)
        {
            GD.PushWarning($"StairsSpawner: Could not load stairs scene from {STAIRS_SCENE}");
            return null;
        }

        var stairs = scene.Instantiate<Stairs>();
    ...
    {
        var scene = GD.Load<PackedScene>(THRONE_SCENE);
        if (scene == null)
        {
            GD.PushWarning($"StairsSpawner: Could not load throne scene from {THRONE_SCENE}");
            return null;
        }

        var throne = scene.Instantiate<ThroneOfDespair>();
