...
/// </summary>
public class MaxWillpowerModifierCondition : Condition
{
    /// <summary>
    /// Amount of max Willpower bonus provided by this condition.
    /// Positive values increase max Willpower, negative values decrease it.
    /// </summary>
    ...
    public override string Name => "Max Willpower Modifier";

    public override string TypeId => "max_willpower_modifier";

    /// <summary>
    /// Parameterless constructor for deserialization.
    /// </summary>
    public MaxWillpowerModifierCondition()
    {
        Amount = 1;
        Duration = "10";
    }
    ...
    /// <summary>
    /// Parameterized constructor for creating max Willpower modifier conditions.
    /// </summary>
    /// <param name="amount">Max Willpower bonus (positive = increase, negative = decrease).</param>
    ...
    public MaxWillpowerModifierCondition(int amount, string duration,
    ...
    public override ConditionMessage OnApplied(BaseEntity target)
    {
        ...
        if (willpower == null)
        {
            GD.PrintErr($"MaxWillpowerModifierCondition: {target.DisplayName} has no WillpowerComponent");
        ...
        string message = DurationMode switch
        {
            ...
            _ => Amount >= 0
                ? $"Max Willpower increased by {Amount}!"
                : $"Max Willpower decreased by {Math.Abs(Amount)}!"
        };
